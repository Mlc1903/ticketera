-- Fix scanner validation for mesa_vip and general tables
...
BEGIN
  ...
  -- Find reservation
  SELECT r.id, r.status, r.guest_name, r.type as res_type, r.event_id, r.ticket_type_id, r.zone_table_id
  INTO v_reservation
